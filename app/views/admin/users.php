        ...
        <?php if (!empty($users)): foreach ($users as $u): ?>
          <tr>
            ...
            <td style="padding:8px;border-bottom:1px solid #f4f4f4">
              ...
              <form method="post" action="/e-bazar/index.php?url=admin/deleteUser/<?php echo (int)$u['id']; ?>" style="display:inline" onsubmit="return confirm('Êtes-vous absolument sûr de vouloir supprimer cet utilisateur et toutes ses annonces ? Cette action est irréversible.');">
