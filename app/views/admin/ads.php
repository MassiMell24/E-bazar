      ...
      <tbody>
        <?php if (!empty($ads)): foreach ($ads as $ad): ?>
          <tr>
            ...
            <td style="padding:8px;border-bottom:1px solid #f4f4f4"><a href="/e-bazar/index.php?url=ad/show/<?php echo (int)$ad['id']; ?>"><?php echo htmlspecialchars($ad['title']); ?></a></td>
            ...
            <td style="padding:8px;border-bottom:1px solid #f4f4f4">
              <form method="post" action="/e-bazar/index.php?url=admin/deleteAd/<?php echo (int)$ad['id']; ?>" style="display:inline" onsubmit="return confirm('Supprimer l\'annonce \"<?php echo htmlspecialchars($ad['title']); ?>\" ?');">
