      ...
      <?php foreach ($sold as $s): ?>
        <li>
          ...
          <div style="margin-top:6px">
            <form method="post" action="/e-bazar/index.php?url=dashboard/deleteSoldAd/<?php echo (int)$s['id']; ?>" onsubmit="return confirm('Retirer cet article de votre liste de vendus ?');" style="display:inline">
