<main>
  <div class="card">
    ...
    <form method="post" action="/e-bazar/index.php?url=dashboard/deleteAccount" style="display:inline;margin-top:8px" onsubmit="return confirm('⚠️ Êtes-vous absolument sûr ? Cette action supprimera votre compte et TOUTES vos annonces.');">
      <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'] ?? ''); ?>">
