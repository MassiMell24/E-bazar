<main>
  <div class="card">
    ...
    <form method="post" action="/e-bazar/index.php?url=ad/store" enctype="multipart/form-data" onsubmit="showConfirm('📢 Publier votre annonce ?\n\nVotre annonce sera visible par tous les utilisateurs.\nVous pourrez la modifier ou la supprimer à tout moment.', this); return false;">
