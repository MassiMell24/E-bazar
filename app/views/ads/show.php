  ...
  <div class="card">
    ...
    <div style="display:flex;gap:16px;flex-wrap:wrap;margin-top:12px">
      ...
      <div style="flex:0 0 320px">
        ...
        <p><strong>Modes de livraison:</strong> <?php echo htmlspecialchars($ad['delivery_modes']); ?></p>
        <?php
        ...
        <?php if (!empty($_SESSION['user_id'])): ?>
          <?php if (($_SESSION['user_id'] == $ad['owner_id']) || !empty($_SESSION['is_admin'])): ?>
            <div style="margin-top:12px">
              <form method="post" action="/e-bazar/index.php?url=ad/delete/<?php echo (int)$ad['id']; ?>" onsubmit="return confirm('Voulez-vous vraiment supprimer cette annonce ?');">
